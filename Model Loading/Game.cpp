...
void Game::Render()
{
	...
	lightBuffer.lightDirection = XMFLOAT3(1.0f, 0.0f, 0.0f);
	lightBuffer.diffuseColor = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	DX::ThrowIfFailed(context->Map(m_lightBuffer.Get(), 0, D3D11_MAP_WRITE_DISCARD, 0, &mapped));
