...
void Game::CreateDeviceDependentResources()
{
	...
	Vertex vertices[3]
	{
		...
		{XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f), XMFLOAT2(0.5f, 0.0f)},
	...
	auto vertexShaderBlob = DX::ReadData(L"D:/Dev/Direct3D Demos/Debug/TexturesVS.cso");

	DX::ThrowIfFailed(
		device->CreateVertexShader(vertexShaderBlob.data(), vertexShaderBlob.size(), nullptr, 
			m_vertexShader.GetAddressOf()));

	auto pixelShaderBlob = DX::ReadData(L"D:/Dev/Direct3D Demos/Debug/TexturesPS.cso");
	...
	DX::ThrowIfFailed(
		device->CreateInputLayout(inputElements, 2, vertexShaderBlob.data(), vertexShaderBlob.size(),
